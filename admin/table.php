...
$sql1 = "SELECT * FROM kh_book_my_tours ORDER BY date DESC";
$result1 = $conn->query($sql1);
$sql2 = "SELECT * FROM kh_animated_gallery ORDER BY date DESC";
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="../images/kodai_logo.png" alt="<?php echo $_SESSION['name'];?>" />
                                        </div>
                                        <div class="content">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="user-data m-b-30">
                                    <h3 class="title-3 m-b-30">
                                        <i class="zmdi zmdi-account-calendar"></i>Image Gallery</h3>
                                    ...
                                    <div class="table-responsive table-data" id="gallery">
                                    <?php if (isset($_SESSION['messaged2']) && !empty($_SESSION['messaged2'])) { ?>
                        <div  class="container alert alert-success" role="alert"><?php echo $_SESSION['messaged2']; ?></div>
                        
                        <?php
                        unset($_SESSION['messaged2']);
                    }
                    ?>
                                        <table class="table">
                                            <thead>
                            ...
                            if ($result2->num_rows > 0) {
                                ...
                                while($row2 = $result2->fetch_assoc()) {
                                    ...
                                    ?>
                                       <tr>
                                         <td><p><?php  echo $row2["description"];?></p></td>        
                                           
                                         <td><img src="../animated_gallery/<?php  echo $row2["path"];?>" alt="" style="width:80px;" srcset=""></td>        
                                    
                                         <td>
                                         <form action="./delete/delete_gallery.php" method="post">
                                         <input type="hidden" name="idelete"  value="<?php  echo $row2["id"];?>">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="user-data m-b-30">
                                    <h3 class="title-3 m-b-30">
                                        <i class="zmdi zmdi-account-calendar"></i>Tour Packages</h3>
                                    <!-- <div class="filters m-b-45">
                                        <div class="rs-select2--dark rs-select2--md m-r-10 rs-select2--border">
                                            <select class="js-select2" name="property">
                                                <option selected="selected">All Properties</option>
